...
#define PORT "30089" // the port client will be connecting to 

#define MAXDATASIZE 501 // max number of bytes we can get at once 
...
/* BEEJ's code: https://beej.us/guide/bgnet/examples/client.c
